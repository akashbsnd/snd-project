          ...
          <div className="container my-5 py-5" data-aos="zoom-out">
            ...
            <div className="row align-items-center my-5 mx-auto">
              ...
              <div className="col-md-8 text-center">
                ...
                <p>
                  I was born and raised in New Jersey. I've moved around a lot and
                  have even lived in Texas for a couple of years. I finished high
                  school in Cary, NC and have lived in Charlotte since 2015. I
                  majored in Computer Science at University of North Carolina at
                  Charlotte Class of '19 and have a masters in Data Science and
                  Business Analytics '20. Since my childhood, I have always been
                  interested in 2 things. Cars, and tech. After working in the
                  tech industry for several years, I decided to pursue my other
                  passion for cars. I learned to work on my 2006 Honda Civic in
                  college to save money, especially because I couldn't afford to
                  pay for a new starter when it went out and I had to get to
                  classes. Today that vehicle has over 300,000 miles and I've
                  helped countless other friends with oil changes, and other
                  diagnostic and maintenance items for their vehicles. But
                  detailing has always stuck out to me because no matter how far
                  you go with it, you can never be perfect. Because of the nature
                  of detailing, you create your own definition of done. As someone
                  who chases perfection, detailing will always challenge me and
                  push me to get closer to perfect, while also striving for
                  efficiency with every car we work on. I met Tenzin in 2023
                  through a mutual friend, and realized I'd found someone with the
                  same mindset and attitude about detailing. And from there, the
                  rest is history.
                </p>
              </div>
            </div>
            ...
            <div className="row align-items-center mt-5 pt-3 mx-auto member-2">
              ...
              <div className="col-md-8 text-center">
                ...
                <h6 className="heading-color">Co-CEO</h6>
                <p>
                  Growing up in New York City, vehicles were luxury items as trains were my primary mode of transportation. My fascination for cars started in 2005, when I picked up one of my childhood favorite games, Need for Speed: Underground. From the plethora of imported cars (Civic Si, 350Z, Integra, and RX-7), different race modes, endless car customization, to the intriguing plot line, this game opened my eyes to the niche of car culture. I studied different brands, car specs, and would actively look for these vehicles when roaming the city. My passion for cars evolved after the 2012 New York International Auto Show, when I learned about the meticulous work that went into the design and production of the Lexus LFA, as I aspired to own one. The first vehicle I detailed was my family-owned RAV4, which I eventually got to take to college in my final semester. After moving to Charlotte, it came time to get my own vehicle. The ES 350 F sport model contained the same sliding speedometer and many design aspects of the LFA so it was a no brainer: I had to have it! After purchasing a 2020 model, I have gone to great lengths to take great care of my Lexus. Through my appreciation of my ES, I was able to learn a lot about detailing and the proper way to maintain a vehicle. I would constantly get asked about detailing services, and eventually, Supreme Nomads Detailing was formed to help others take care of their prized possessions. Akash and I connected through our shared enthusiasm for cars and detailing. 
                </p>
              </div>
            </div>
          </div>
